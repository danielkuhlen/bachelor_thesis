...
# global data import -----------------------------------------------------------
tweets <- import("../02_output_data/tweets_master.rds")
accounts <- import("../02_output_data/pol_twitter_accounts.rds")

# import twitter accounts
candidates2021_raw <- import("../01_raw_data/twitter2021.rds")
```
